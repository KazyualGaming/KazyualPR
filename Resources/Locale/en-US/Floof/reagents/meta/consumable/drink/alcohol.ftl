...
reagent-name-nikkoscumlust = nikko's cum-lust
reagent-desc-nikkoscumlust = Created in spirit of all of the feisty crewmembers on board.

reagent-name-nikkossluttycumlust = nikko's slutty cum-lust
reagent-desc-nikkossluttycumlust = For those looking for an even more intense version.
...
reagent-name-creambar = cream bar
reagent-desc-creambar = Sourced from the bar itself.

reagent-name-sweetbloodshot = sweet blood shot
reagent-desc-sweetbloodshot = A very, very fruity shot.
...
reagent-desc-specialsundae = A pleasing enough mix of ice cream and pomegranate-- with one extra ingredient, in place of the nuts.
