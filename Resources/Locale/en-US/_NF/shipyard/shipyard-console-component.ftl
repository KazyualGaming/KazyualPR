...
shipyard-console-job-restricted = Your job doesn't let you pilot a ship!
...
## Error Messages
shipyard-console-checksum-failure = WARNING: Vessel manifest corrupted! Loading aborted. Contact Central Command immediately.
