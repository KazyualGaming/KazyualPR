...
|--------------|-----------|-----------------|---------|
| **`_Sandwich`** | **Sandwich Station** | https://github.com/SandwichStation | **AGPL-3.0-or-later** |
...
| `Monolith` | Monolith | https://github.com/Monolith-Station/Monolith | AGPL 3.0 |
| `White Dream` | White Dream | https://github.com/WWhiteDreamProject/wwdpublic | AGPL 3.0 |
